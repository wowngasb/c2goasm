...
LBB0_7:
    QUAD $0x000000f78458fdc5; BYTE $0x00 // vaddpd    ymm0, ymm0, yword [rdi + 8*rsi]
    QUAD $0x000020f78c58f5c5; BYTE $0x00 // vaddpd    ymm1, ymm1, yword [rdi + 8*rsi + 32]
    QUAD $0x000040f79458edc5; BYTE $0x00 // vaddpd    ymm2, ymm2, yword [rdi + 8*rsi + 64]
    QUAD $0x000060f79c58e5c5; BYTE $0x00 // vaddpd    ymm3, ymm3, yword [rdi + 8*rsi + 96]
...
LBB0_10:
	...
	JE LBB0_12
LBB0_11:
    LONG $0x4458fbc5; WORD $0x08cf // vaddsd    xmm0, xmm0, qword [rdi + 8*rcx]
...
LBB0_5:
    ...
    LONG $0xd257e9c5             // vxorpd    xmm2, xmm2, xmm2
    LONG $0xdb57e1c5             // vxorpd    xmm3, xmm3, xmm3
    QUAD $0x9090909090c0854d; WORD $0x9090 // test    r8, r8
	JNE LBB0_9
	JMP LBB0_10
